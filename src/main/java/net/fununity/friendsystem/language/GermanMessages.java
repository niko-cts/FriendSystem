...
public class GermanMessages extends MessageList {
    ...
    public GermanMessages() {
        ...
        add(TranslationKeys.FRIENDS_GUI_FRIEND_LORE, "&7Befreundet seit: &e${friendssince};&7Zuletzt online: &e${lastonline};&7Spielzzeit: &e${playtime} Stunden");
        ...
        add(TranslationKeys.FRIENDS_GUI_FRIEND_CHATROOM_LORE, "&7Lade deinen Freund;&7in deinen &bClub&7 ein.;&8" + SpecialChars.DOUBLE_ARROW_RIGHT + " &bComing soon!");
